...
using DatabaseLib.Migrations;

namespace DatabaseLib
{
    // Um eine neu Migration auszuführen:
    // Add-Migration CreateDB -Project DatabaseLib -StartupProject NodeMonitor

    // Um die letzte Migration rückgängig zu machen:    
    // Remove-Migration -Project DatabaseLib -StartupProject NodeMonitor

    // Um die Datenbank zu erstellen oder upzudaten
    // Update-Database -Project DatabaseLib -StartupProject NodeMonitor
    ...
    public class nmDBContext : DbContext
    {
        ...
        public DbSet<PublicConfig> PublicConfigs { get; set; }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            //        _connectionString = _connectionString + AppConfig.ReadSetting("Database_Ip");
            //        _connectionString = _connectionString + ",";
            //        _connectionString = _connectionString + AppConfig.ReadSetting("Database_Port");
            //        _connectionString = _connectionString + ";";
            //        _connectionString = _connectionString + "initial catalog=";
            //        _connectionString = _connectionString + AppConfig.ReadSetting("Database_Catalog");
            //        _connectionString = _connectionString + ";";
            //        _connectionString = _connectionString + "User ID=";
            //        _connectionString = _connectionString + AppConfig.ReadSetting("Database_User");
            //        _connectionString = _connectionString + ";";
            //        _connectionString = _connectionString + "Password=";
            //        _connectionString = _connectionString + AppConfig.ReadSetting("Database_Password");
